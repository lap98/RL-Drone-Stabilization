...
save_path = "C:/Users/vince/Downloads/advanced_deep_learning/project/python_code/training_data/20220923_143031/states/1663936379.8382413.npy"
...
for i in range(len(states)):
    rot = R.from_quat([states[i,3], states[i,4], states[i,5], states[i,6]])
...
dump_path = "C:/Users/vince/Downloads/advanced_deep_learning/project/python_code/drone_deploy/drone_data/data_dump0.npy"
states_drone = np.load(dump_path)
# x_roll y_pitch z_yaw v_x v_y v_z acc_x acc_y acc_z gyr_x gyr_y gyr_z gyr_x gyr_y acc_x acc_y acc_z gyr_x gyr_y gyr_z gyr_offset
